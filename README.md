...
```
 ...
 When the file is successfully uploaded to the serve, it is placed on a temporary folder.

 The path to this directory can be found in the "files" object, passed as the 3rd argument in the parse() method's callback function.

 To move the file to the folder of your choice, use the file system module and rename file.
 ### Example
 ...
 Makes it easy to send emails from your computer.
  ...
  ```
  ### Send an Email
  Now you are ready to dend emails from your server.

  Use the username and password from your selected email provider to send an email.

  This will show you how to use your gmail account to send an email.
  ...
  var mailOptions = {
    from: 'youremail@gmail.com',
    to: 'myfriend@yahoo.com','myanotherfriend@gmail.com',
    subject: 'Sending Email Using Node.js',
    text: 'That was easy!'
  }
  ``` 
